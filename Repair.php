...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE song SET songName='$songName',songFile='$songFile',songIMG='$songIMG', genreID='$genreID' WHERE songID='$songID'";
    if ($connect->query($sql) === TRUE) {
            echo "<script>alert('Song update successfully!')</script>";
...
<fieldset>
<!-- Form Name -->
<legend style="text-align: center;font-size: 50px;">Edit Song</legend>
